        ...
        <Container >
          {/* <div className="Estilo-Tabla">
            ...
            <div style={{width:"500px"}}>
              ...
              {this.state.data.map((dato,item) => (
                
                 <div >
                <p className="parrafo "><strong>Nombre Cliente : </strong>&nbsp; {dato.recaudos[item].nombreCliente} </p>
                <p className="parrafo "><strong>Codigo : </strong>&nbsp;{dato.recaudos[item].codigoMaquina} </p>
                <p className="parrafo "><strong>Direccion : </strong>&nbsp; {dato.recaudos[item].direccion} </p>
                <p className="parrafo "><strong>Tipo de Maquina: </strong>&nbsp; {dato.recaudos[item].tipoMaquina}</p>
                </div>
              ))}
            ...
            <tbody>
              {this.state.data.map((dato,item) => (
                ...
                <tr key={dato.id}>
                  <td>{dato.id}</td>
{/*                   
                  <td>{dato.recaudos[item+1].fecha}</td>
                  <td>{dato.recaudos[item].contadorInicial}</td>
                  <td>{dato.recaudos[item].contadorFinal}</td>
                  <td>{dato.recaudos[item].diferencia}</td>
                  <td>{dato.recaudos[item].porcentajeCliente}</td>
                  <td>{dato.recaudos[item].totalCliente}</td> */}
